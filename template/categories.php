    ...
    <div class="container">
        <div class="categories-wrapper">
            <div class="swiper categories-slider">
                    ...
                    <div class="swiper-slide">
                        <div class="category-item">
                            <a href="" class="category-item-link">
                                <p class="category-item-title line-1">
                                    بهداشت و کارهای شخصی
                                </p>
                                <div class="category-item-topics line-1">
                                    <span>کفش پوشیدن</span>
                                    <span>مسواک زدن</span>
                                    <span>زباله ریختن</span>
                                </div>
                ...
                <div class="swiper-pagination swiper-categories-pagination "></div>
            </div>
        </div>
    </div>
</section>